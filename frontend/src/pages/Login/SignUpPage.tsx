    ...
    <div style={{ minHeight: "100vh", background: "#fff" }}>
      ...
      <main style={{ display: "flex", flexDirection: "column", alignItems: "center", marginTop: "60px" }}>
        <div style={{
          ...
          <h2 style={{ fontWeight: 700, fontSize: "32px", marginBottom: "8px" }}>Create Account</h2>
          <p style={{ color: "#555", marginBottom: "24px" }}>Join Study Buddy Match to find your learning partner</p>
          ...
          <div>
            <span style={{ color: "#555", fontSize: "16px" }}>
              ...
              <a href="/login" style={{ color: "#000", textDecoration: "underline", fontWeight: 600 }}>
                Sign in
              </a>
            </span>
          </div>
